...
class FiasJobFactory
{
    ...
    protected $entitiesDescription = [
        'Object' => [
            'xml_path' => '/AddressObjects/Object',
            'primary' => 'AOID',
            'xml_fields' => [
                'AOID' => '@AOID',
                'AOGUID' => '@AOGUID',
            ...
            'file_regexp' => 'AS_ADDROBJ_.*\.XML',
        ],
        'House' => [
            'xml_path' => '/Houses/House',
            'primary' => 'HOUSEID',
            'xml_fields' => [
                'HOUSEID' => '@HOUSEID',
                'HOUSEGUID' => '@HOUSEGUID',
            ...
            'file_regexp' => 'AS_HOUSE_.*\.XML',
        ],
        'NormativeDocument' => [
            'xml_path' => '/NormativeDocumentes/NormativeDocument',
            'primary' => 'NORMDOCID',
            'xml_fields' => [
                'NORMDOCID' => '@NORMDOCID',
                'DOCNAME' => '@DOCNAME',
